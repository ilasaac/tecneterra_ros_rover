...
class RoverPositionManager(
    ...
    /**
     * Upload a corridor mission: list of corridor centerlines with a given width.
     ...
     */
    fun uploadCorridorMission(sysId: Int, corridors: List<List<LatLng>>, width: Float) {
        uploadJobs[sysId]?.cancel()
        uploadJobs[sysId] = scope.launch {
            var seq = 0
