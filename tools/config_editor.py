...
DESCRIPTIONS = {
    ...
    'control_algorithm': 'Lateral control strategy: stanley, mpc, ttr, or afs.',
    'afs_cte_scale_m': 'CTE (m) at which speed scales down to min_speed (AFS only).',
    'afs_cte_alarm_m': 'CTE (m) above which the rover triggers a safety halt (AFS only).',
    'afs_approach_dist_m': 'Distance (m) from turn waypoint to enter approach phase (AFS only).',
    'afs_min_throttle_ppm': 'Minimum PPM value for forward motion to overcome motor stiction.',
    ...
    'ttr_angle_kp': 'Proportional gain for TTR heading PID.',
    'ttr_angle_ki': 'Integral gain for TTR heading PID.',
    'ttr_angle_kd': 'Derivative gain for TTR heading PID.',
    'ttr_hight_kp': 'Proportional gain for TTR CTE (height) PID.',
    'ttr_hight_ki': 'Integral gain for TTR CTE (height) PID.',
    'ttr_hight_kd': 'Derivative gain for TTR CTE (height) PID.',
    'ttr_max_yaw_distance': 'CTE (m) at which speed factor reaches minimum in TTR.',
    'ttr_target_dece_dis': 'Distance (m) from waypoint where deceleration begins in TTR.',
    'mpc_horizon': 'Number of future steps to predict in MPC.',
    'mpc_dt': 'Time step (s) for MPC prediction.',
    'mpc_w_cte': 'MPC weight for cross-track error.',
    'mpc_w_heading': 'MPC weight for heading error.',
    'mpc_w_steer': 'MPC weight for steering effort.',
    'mpc_w_dsteer': 'MPC weight for steering rate change.',
    'wheelbase_m': 'Distance (m) between the front and rear axles/antennas.',
